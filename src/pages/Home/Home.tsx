    ...
    <div className="Home">
      <div className="flex flex-col items-center justify-center bg-gray-50">
        <div className="w-11/12 xl:w-1/2">
          <h1 className="leading-0 text-center font-mainFont text-6xl font-bold text-gray-800 2xl:leading-10">
            A passion that reunite all of us
          </h1>
          <h2
            role="contentinfo"
            className="mt-5 text-center font-secondaryFont text-base leading-normal text-gray-600"
          >
